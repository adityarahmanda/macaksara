<template>
    <div>
        ...
        <p>This privacy policy applies to the Macaksara app (hereby referred to as "Application") for mobile devices that was created by Aditya Rahmanda (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
    ...
    they will be able to take the necessary actions.</p>
        ...
        <p>This privacy policy is effective as of 2024-11-03</p>
